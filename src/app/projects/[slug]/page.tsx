    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black">
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">Compétences BTS mobilisées</h2>
            <div className="space-y-3">
              {Object.entries(project.e5.competencesBTS).map(([key, value]) => (
                <div key={key} className="bg-gray-800/30 p-4 rounded border border-gray-600">
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">Résultats obtenus</h2>
            <ul className="list-disc list-inside text-gray-300 space-y-2">
              {project.e5.resultats.map((resultat, index) => (
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">Difficultés rencontrées</h2>
            <p className="text-gray-300">{project.e5.difficultes}</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-white mb-4">Solutions apportées</h2>
            <p className="text-gray-300">{project.e5.solutionsApportees}</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-white mb-4">Améliorations possibles</h2>
            <p className="text-gray-300">{project.e5.ameliorations}</p>
          </section>
        </div>
      </div>
    </main>
